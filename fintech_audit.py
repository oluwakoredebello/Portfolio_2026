...
def assignment_logic(tenure, login_gap_days):
    ...
    return gateway_choice, status_choice
...
for i in range(1_500_000):
    ...
    gateway_choice, status_choice = assignment_logic(years_with_the_firm, login_gap_days)
